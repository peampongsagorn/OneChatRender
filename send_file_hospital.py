...
def send_file_hospital(start_date, end_date):
    ...
    df_results = pd.DataFrame(results, columns=['organization_code', 'name_health', 'count_hospital_all',
                                                 'count_hospital_otp', 'count_hospital_idc', 'date_cutoff'])

    filename = f"HealthID_Count_Hospital_{start_date}_{end_date}.csv"
