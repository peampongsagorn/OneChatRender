...
def send_file_last_update(start_date, end_date):
    ...
    df_results = pd.DataFrame(results, columns=['organization_code', 'name_health', 'count_healthid_all',
                                                 'count_healthid_otp', 'count_healthid_idc', 'date_cutoff'])

    filename = f"HealthID_Count_LastUpdate_{start_date}_{end_date}.csv"
