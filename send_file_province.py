...
def send_file_province(start_date, end_date):
    ...
    df_results = pd.DataFrame(results, columns=['organization_code', 'name_health', 'province_health', 'count_province_all',
                                                 'count_province_otp', 'count_province_idc', 'date_cutoff'])

    filename = f"HealthID_Count_Province_{start_date}_{end_date}.csv"
